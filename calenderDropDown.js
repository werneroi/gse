...
//Hours method
function hours(tags, startH, endH)
{
	...
	//You can call the class multiple times						
    var multiple_list = document.getElementsByClassName("bear-hours");
    for (i = 0; i < multiple_list.length; i++)
	{
    	multiple_list[i].innerHTML = hours;
    }	
}

//Minutes method
function minuts(tags)
{		var list_minutes = [
							'00',
							'15',
							'30',
		...
		{
			var minutes = "";
			for (i = 0, l = list_minutes.length, minutes = ""; i < l; i++)
			{
				minutes += list_minutes[i];
			}
		}
		else
		//If the years('option') has paramenter, add the tags to it
		{
			for (i = 0, l = list_minutes.length, minutes = ""; i < l; i++)
			{
				minutes += "<" + tags +">" + list_minutes[i] + "</" + tags +">";
			}	
		}
		
	//You can call the class multiple times						
    var multiple_list = document.getElementsByClassName("bear-minuts");
    for (i = 0; i < multiple_list.length; i++)
	{
    	multiple_list[i].innerHTML = minutes;
    }	
}
